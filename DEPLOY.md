...
\1<removed-from-history>r-api-key
\1<removed-from-history>r-api-secret
...
3. Update `FROM_EMAIL` to use your verified domain:
   ...
   FROM_EMAIL=Reflexity RAM <noreply@reflexityram.com>
   ```
4. Add `RESEND_API_KEY` in your backend host environment variables
...
This repository is licensed under the Apache License, Version 2.0. See `LICENSE` and `NOTICE`.
