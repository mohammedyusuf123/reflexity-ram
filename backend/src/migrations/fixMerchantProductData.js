...
const corrections = [
  {
    ...
    values: {
      ...
      ecc: true,
      rank: '4Rx4',
      'images.0.url': 'https://res.cloudinary.com/dfquny0nk/image/upload/v1785445409/reflexity-ram/products/product-1785445408907-uc07t4fnt.jpg',
  ...
  },
  {
    ...
    values: {
      ...
      ecc: true,
      rank: '4Rx4',
      'images.0.url': 'https://res.cloudinary.com/dfquny0nk/image/upload/v1783288682/reflexity-ram/products/product-1783288682346-dye6s9nnk.jpg',
...
module.exports = { fixMerchantProductData };
