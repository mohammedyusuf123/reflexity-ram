...
router.post('/', async (req, res) => {
  ...
  const products = [
    { name: '32GB (2x16GB) DDR5-6000 CL30 EXPO Kit', slug: 'rfx-d5-32-6000-cl30-expo', sku: 'RFX-D5-32-6000-CL30', description: 'High-performance DDR5 for AMD AM5. 2x16GB EXPO + XMP 3.0.', line: 'Desktop', generation: 'DDR5', formFactor: 'UDIMM', capacity: 32, capacityLabel: '32GB', kit: '2 x 16GB', speed: 6000, speedLabel: '6000 MT/s', cas: 'CL30', timings: '30-38-38-96', voltage: '1.35V', ecc: false, rgb: false, heatspreader: 'Aluminum, low-profile black', condition: 'New', warranty: 'Limited Lifetime', price: 119.0, compareAt: 139.0, stock: 'in', stockLabel: 'In stock', stockQuantity: 50, isFeatured: true, tags: ['DDR5','EXPO','AM5'], images: [] },
    { name: '64GB (2x32GB) DDR5-6400 CL32 Kit', slug: 'rfx-d5-64-6400-cl32', sku: 'RFX-D5-64-6400-CL32', description: 'Massive 64GB DDR5 for workstations. 2x32GB XMP 3.0 + EXPO.', line: 'Desktop', generation: 'DDR5', formFactor: 'UDIMM', capacity: 64, capacityLabel: '64GB', kit: '2 x 32GB', speed: 6400, speedLabel: '6400 MT/s', cas: 'CL32', timings: '32-39-39-102', voltage: '1.4V', ecc: false, rgb: false, heatspreader: 'Aluminum, brushed silver', condition: 'New', warranty: 'Limited Lifetime', price: 219.0, compareAt: 259.0, stock: 'in', stockLabel: 'In stock', stockQuantity: 20, isFeatured: true, tags: ['DDR5','XMP','High Capacity'], images: [] },
    ...
    { name: '32GB (2x16GB) DDR4-3600 CL16 XMP Kit', slug: 'rfx-d4-32-3600-cl16', sku: 'RFX-D4-32-3600-CL16', description: 'Sweet-spot DDR4 for AM4 and LGA1200. 2x16GB CL16 XMP 2.0.', line: 'Desktop', generation: 'DDR4', formFactor: 'UDIMM', capacity: 32, capacityLabel: '32GB', kit: '2 x 16GB', speed: 3600, speedLabel: '3600 MT/s', cas: 'CL16', timings: '16-19-19-39', voltage: '1.35V', ecc: false, rgb: false, heatspreader: 'Aluminum, matte black', condition: 'New', warranty: 'Limited Lifetime', price: 89.0, compareAt: 109.0, stock: 'low', stockLabel: 'Low stock', stockQuantity: 8, isFeatured: true, tags: ['DDR4','XMP','Ryzen sweet-spot'], images: [] },
