      ...
      <body style="margin:0;padding:0;background:#0a0a0c;font-family:'Figtree',system-ui,sans-serif;color:#f5f5f7;">
        <div style="max-width:560px;margin:40px auto;padding:0 20px;">
          <div style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.08);border-radius:16px;padding:40px;">
            ...
            <p style="color:#a0a0aa;margin:0 0 32px;line-height:1.6;">Hi ${firstName}, welcome to Reflexity RAM. Please verify your email address to activate your account.</p>
            <a href="${verifyUrl}" style="display:inline-block;background:#f5f5f7;color:#050505;text-decoration:none;padding:14px 28px;border-radius:8px;font-weight:600;font-size:14px;">Verify Email Address</a>
            ...
            <p style="color:#5a5a64;font-size:11px;margin:16px 0 0;">Or copy this URL: <a href="${verifyUrl}" style="color:#8a8a92;">${verifyUrl}</a></p>
          </div>
        </div>
      </body>
      </html>
      ...
      <body style="margin:0;padding:0;background:#0a0a0c;font-family:'Figtree',system-ui,sans-serif;color:#f5f5f7;">
        <div style="max-width:560px;margin:40px auto;padding:0 20px;">
          <div style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.08);border-radius:16px;padding:40px;">
            ...
            <p style="color:#a0a0aa;margin:0 0 32px;line-height:1.6;">Hi ${firstName}, we received a request to reset your password. Click below to choose a new one.</p>
            <a href="${resetUrl}" style="display:inline-block;background:#f5f5f7;color:#050505;text-decoration:none;padding:14px 28px;border-radius:8px;font-weight:600;font-size:14px;">Reset Password</a>
...
const sendOrderConfirmationEmail = async ({ email, firstName, order }) => {
  const orderUrl = `${FRONTEND_URL}/order/${order.orderNumber}`;

  const itemsHtml = order.items.map(item => `
    <tr>
      <td style="padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.05);">
        <div style="font-size:13px;color:#f5f5f7;">${item.name}</div>
      ...
      <body style="margin:0;padding:0;background:#0a0a0c;font-family:'Figtree',system-ui,sans-serif;color:#f5f5f7;">
        <div style="max-width:560px;margin:40px auto;padding:0 20px;">
          <div style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.08);border-radius:16px;padding:40px;">
            ...
            <h1 style="font-size:22px;font-weight:700;margin:0 0 8px;letter-spacing:-0.5px;">Thanks, ${firstName}!</h1>
            <p style="color:#a0a0aa;margin:0 0 8px;font-size:13px;">Order <span style="font-family:monospace;color:#f5f5f7;">${order.orderNumber}</span></p>
            ...
            <div style="margin-top:32px;">
              <a href="${orderUrl}" style="display:inline-block;background:#f5f5f7;color:#050505;text-decoration:none;padding:12px 24px;border-radius:8px;font-weight:600;font-size:13px;">View Order Details</a>
            </div>
      ...
      <body style="margin:0;padding:0;background:#0a0a0c;font-family:'Figtree',system-ui,sans-serif;color:#f5f5f7;">
        <div style="max-width:560px;margin:40px auto;padding:0 20px;">
          <div style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.08);border-radius:16px;padding:40px;">
            ...
            <p style="color:#a0a0aa;margin:0 0 24px;line-height:1.6;">Hi ${firstName}, your order <span style="font-family:monospace;color:#f5f5f7;">${order.orderNumber}</span> has been shipped.</p>
            ${order.trackingNumber ? `<p style="color:#a0a0aa;font-size:13px;">Tracking: <span style="font-family:monospace;color:#f5f5f7;">${order.trackingNumber}</span></p>` : ''}
            <a href="${orderUrl}" style="display:inline-block;background:#f5f5f7;color:#050505;text-decoration:none;padding:12px 24px;border-radius:8px;font-weight:600;font-size:13px;margin-top:16px;">Track Order</a>
          </div>
        </div>
      </body>
      </html>
